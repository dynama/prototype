...
#This function creates the database from the dynama program. It sets up the 
#different tables, and establishes the connection, username/password for the 
#program to communicate to the table to insert/call data.
...
#The below functions are set up in this module for the use of the rest 
#of the modules of dynama. They serve to allow the other modules to insert 
#or pull data to/from the database that is captured by dynama. This allows 
#the modules the ability to analyze the data collected in the database to 
#help determine if the DNS packet is potentially malware.
